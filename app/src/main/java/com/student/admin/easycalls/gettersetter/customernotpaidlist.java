...
public class customernotpaidlist {
    ...
    public class List
    {
        ...
        public String toString()
        {
            return "ClassPojo [executive_other = "+executive_other+", executive_transtype = "+executive_transtype+", executive_summary = "+executive_summary+", customer_phone = "+customer_phone+", dispo_code = "+dispo_code+", employee_name = "+employee_name+", Id = "+Id+", customer_name = "+customer_name+", customer_accno = "+customer_accno+", executive_time = "+executive_time+"]";
        }
    }
